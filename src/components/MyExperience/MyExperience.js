...
const Myexperience = ({ theme }) => {
  return (
    <div
      id="experience"
      className="flex h-1/2 w-full justify-center bg-white px-64 pt-16 transition-colors duration-500 ease-out dark:bg-zinc-900"
    >
      <div className="flex h-full w-5/6 flex-col ">
        ...
        <div className="flex h-full w-full  gap-20 py-10 pt-14">
          <div className="relative flex h-full w-1/2 flex-col  ">
            <div className="flex h-1/2 w-full">
              ...
              <div className="flex h-full w-1/2 grow gap-x-2">
            ...
            <div className="flex h-1/2 w-full ">
              ...
              <div className="flex h-full w-1/2 gap-x-2 ">
                ...
                <div>
                  ...
                  <motion.h2 className="pt-1 text-sm font-light text-zinc-800 transition-all duration-1000 dark:font-bold dark:text-red-600">
                    Oh god.
                  </motion.h2>
                </div>
              </div>
