...
const Cards = ({ theme }) => {
  ...
  return (
    <div
      id="portfolio"
      className="flex h-1/2 w-full justify-center  bg-gray-100 px-64 transition-colors duration-500 ease-out dark:bg-zinc-800"
    >
      <div className="flex h-full w-2/3 flex-col   py-6">
        <div className="mb-5 flex w-full flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-3 ">
            ...
            <div className="h-0.5 w-48 rounded bg-zinc-900 transition-colors duration-500 ease-out dark:bg-gray-100" />
          </div>
        </div>
